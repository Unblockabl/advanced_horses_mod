...
{
    public static final ResourceLocation OIL_STILL_RL = new ResourceLocation(horse_mod.MOD_ID,
            "block/oil_still");

    public static final ResourceLocation OIL_FLOWING_RL = new ResourceLocation(horse_mod.MOD_ID,
            "block/oil_flowing");

    public static final ResourceLocation OIL_OVERLAY_RL = new ResourceLocation(horse_mod.MOD_ID,
            "block/oil_overlay");
    ...
    public static final ForgeFlowingFluid.Properties OIL_PROPERTIES = new ForgeFlowingFluid.Properties(
            ...
            .viscosity(5)).slopeFindDistance(Config.OIL_SPREAD_DISTANCE.get()).levelDecreasePerBlock(Config.OIL_SPREAD_DISTANCE.get())
